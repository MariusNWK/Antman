...
list_t *display_compressed(list_t *, char *);
int is_same_str(char *, char *);
list_t *set_basic_entry(list_t *);
void free_entry(list_t *);
char *find_new_entry(list_t *, char *, char *, int);
int display_dictionnary(list_t *);
list_t *output_last_char(list_t *, char *, int);
